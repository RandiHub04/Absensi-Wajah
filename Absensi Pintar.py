...
# judul
judul = tk.Label(root, text="Absensi Mahasiswa Ilmu Komputer", font=("Roboto",32),bg="#242526", fg="white")
canvas.create_window(350, 80, window=judul)
#credit
made = tk.Label(root, text="Made by Tim Ilkom", font=("Times New Roman",13), bg="black",fg="white")
...
canvas.create_window(70,170, window=label1)
# for entry data nim
...
intructions = tk.Label(root, text="Mulai Absen!", font=("Roboto",15),fg="white",bg="black")
canvas.create_window(360, 300, window=intructions)
